...
/*   Updated: 2025/05/25 18:28:39 by zkhojazo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap() : _name("Default"), _hitPts(HIT_POINTS), _energyPts(ENERGY_POINTS), _attackDmg(ATTACK_DAMAGE) {
	std::cout << "Default ClapTrap Constructor called" << std::endl;
}

ClapTrap::ClapTrap(std::string const &name) : _name(name), _hitPts(HIT_POINTS), _energyPts(ENERGY_POINTS), _attackDmg(ATTACK_DAMAGE) {
